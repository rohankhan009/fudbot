"""
PAPIATMA BACKEND - Clean version
Telegram Admin Bot + FastAPI
Koi force-join nahi, koi channel nahi.
"""
...
# ---------------- CONFIG ----------------
BOT_TOKEN = os.environ.get("PAPIATMA_BOT_TOKEN", "8593499068:AAEHgDmfMjs6UzIcuVZVfthtY6ezJd_vPyQ").strip()
...
# ================================================================
#  TELEGRAM ADMIN BOT - CLEAN (NO FORCE JOIN)
# ================================================================
